...
export default function Filters({ statuses, filter, counts, showScope, onChange, onReset }) {
  ...
  return (
    <div className="filters">
      ...
      <div className="filters__form">
        ...
        />
        {/* Менеджер и администратор видят задачи всех пользователей и могут сузить выборку до своих. */}
        {showScope && (
          <select
            value={filter.scope}
